...
from rapid_data import RAPID_DATA

class Rapid(pg.sprite.Sprite):
  def __init__(self, sprite_sheets, tile_x, tile_y, shot_fx):
    pg.sprite.Sprite.__init__(self)
    self.upgrade_level = 1
    self.range = RAPID_DATA[self.upgrade_level - 1].get("range")
    self.cooldown = RAPID_DATA[self.upgrade_level - 1].get("cooldown")
    ...
    self.animation_list = self.load_images(self.sprite_sheets)
    self.frame_index = 0
